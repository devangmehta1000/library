...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        // fetch the authorname property by concatenating firstname and lastname
        ...
        CreateMap<Services.Models.Book, Controllers.Models.Author>()
            ...
            {
                // instead of specifying the output dob as string, the similar result could be achived by using json formatters in program startup.
